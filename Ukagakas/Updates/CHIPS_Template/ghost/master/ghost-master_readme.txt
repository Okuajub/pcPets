...
You can safely ignore the "dict" folder unless you're trying to learn how to program in Kawari. If you're just here as a writer, you're going to be mainly focused on the "ghost-*" files.
...
profile (folder) - This folder holds files that your baseware (most likely SSP) uses. You can ignore it until you publish your Ghost, at which point you should delete it before you create their public files.
...
dict-bakdata.txt and dict-savedata.txt - if you see these in your folder, they're your Ghost's save data! You can leave them alone, but you should delete them before you publish your Ghost, just like the profile folder.
...
icon.ico - The icon for your ghost that shows up in the task tray. If you don't want to fiddle around with making one (such as by converting a .png to an .ico), you can just delete this.

kawari.log - A log file automatically created by Kawari when your Ghost boots. If you're having issues with something, kawari.log will log any errors and all the events sent to the Ghost.
...
That covers most of what you'll find here. Oh, and of course, you can safely delete this file if you'd like, too. It's here just for you, the user!